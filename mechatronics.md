...
All the code was written in C, and we used a olor sensorto determine what side of the board we were on while preventing out-of-bounds movement using QTI sensors. I also designed and bent all sheet metal parts, including the arms and plow.  
